 ...
 *
 *<p>This Class handles orderers in an iterable pattern.
 *
 */
public class Order implements Iterable<Item> {
    ...
    public Order() {
        ...
        this.orderNumber = OrderNumberSingleton.getNextOrderNumber();
    }

    /**
     * Method to get Order's number.
     *
     * @return Order number for current order
     */
    ...
    /**
     * Getter for total calories of the order.
     *
     * @return total amount of calories for order
     */
